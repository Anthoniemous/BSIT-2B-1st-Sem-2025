...
<body>
    <?php
        echo "This is an echo<br>",
            "this is also an echo but in a single line of echo but multiple arguments<br>",
            "using \"()\" is optional only<br>",
            "Style for echo<br><div class=\"custom-echo\">My Custom Echo</div>";
